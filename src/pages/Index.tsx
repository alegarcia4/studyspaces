  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-studyspot-purple hover:bg-gray-100">
                <Link to="/spots">Find Study Spaces</Link>
              </Button>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why StudySpace?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-3">Find Nearby Spaces</h3>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">Top Rated Study Spaces</h2>
      ...
      <section className="bg-studyspot-soft-purple py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6 gradient-text">Know a Great Study Space?</h2>
          ...
          <Button asChild size="lg" className="bg-studyspot-purple hover:bg-studyspot-light-purple">
            <Link to="/submit">Add a Study Space</Link>
          </Button>
        </div>
      </section>
